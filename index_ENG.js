var s_ser = "HGR", s_size = "15R", s_res = "yet to evaluate";
...
function EvaluateRail(){
    ...
    if(resNum % 1 == 0)
        ...
        result = ", INVALID RAIL"
    s_res = resNum + " steps (pitch size = " + PitchFromType(s_ser + s_size) + " mm)" + result;
    MakeCode();
}
...
function MakeCode(){
    ...
    document.getElementById("resultlabel").innerHTML = s_ser + s_size + " rail verification result: " + s_res;
}